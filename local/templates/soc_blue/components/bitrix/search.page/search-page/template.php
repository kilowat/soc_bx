...
<?else:?>
	<input type="text" name="q" class="input search-page-input" value="<?=$arResult["REQUEST"]["QUERY"]?>" size="40" />
<?endif;?>
...
<?endif;?>
	&nbsp;<input class="btn btn-accent" type="submit" value="<?=GetMessage("SEARCH_GO")?>" />
